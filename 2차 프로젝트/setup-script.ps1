...
$scriptBlock = {
    [System.Environment]::SetEnvironmentVariable("APPIUM_MAIN_JS_PATH", "C:\path\to\appium\main.js", [System.EnvironmentVariableTarget]::Machine)
    [System.Environment]::SetEnvironmentVariable("AUTOMATION_HOME", "C:\", [System.EnvironmentVariableTarget]::Machine)
}
